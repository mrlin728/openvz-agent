...
function parseArgs(argv) {
  const args = {
    ...
    timeoutMs: 180000,
    start: '',
    localName: '本机OpenVZ Agent',
    peerName: '远端OpenVZ Agent',
    token: '',
  }
...
function buildIntro(args) {
  return args.start || [
    '你正在通过局域网和另一只OpenVZ Agent进行一次受控对话。',
    `对方地址是 ${args.peer}。`,
    '请用一小段话向对方打招呼，介绍你是谁，并问一个适合两只OpenVZ Agent互相认识的问题。',
