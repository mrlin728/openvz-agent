...
contextBridge.exposeInMainWorld('openvz', desktopBridge)
// 2.x compatibility: existing renderer extensions still use window.bailongma.
contextBridge.exposeInMainWorld('bailongma', desktopBridge)
